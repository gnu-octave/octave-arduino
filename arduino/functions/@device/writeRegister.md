...
<dt class="deftypefn def-line" id="index-writeRegister"><span class="category-def">: </span><span><strong class="def-name">writeRegister</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">reg</var>, <var class="var">datain</var>)</code><a class="copiable-link" href="#index-writeRegister"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-writeRegister-1"><span class="category-def">: </span><span><strong class="def-name">writeRegister</strong> <code class="def-code-arguments">(<var class="var">dev</var>, <var class="var">dev</var>, <var class="var">datain</var>, <var class="var">precision</var>)</code><a class="copiable-link" href="#index-writeRegister-1"></a></span></dt>
