...
<dt class="deftypefn def-line" id="index-readDistance"><span class="category-def">: </span><span><code class="def-type"><var class="var">distance</var> =</code> <strong class="def-name">readDistance</strong> <code class="def-code-arguments">(<var class="var">dev</var>)</code><a class="copiable-link" href="#index-readDistance"></a></span></dt>
