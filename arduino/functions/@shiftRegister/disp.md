...
<dt class="deftypefn def-line" id="index-disp"><span class="category-def">: </span><span><strong class="def-name">disp</strong> <code class="def-code-arguments">(<var class="var">register</var>)</code><a class="copiable-link" href="#index-disp"></a></span></dt>
