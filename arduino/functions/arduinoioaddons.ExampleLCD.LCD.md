...
<dt class="deftypefn def-line" id="index-arduinoioaddons_002eLCDAddon_002eLCD"><span class="category-def">: </span><span><strong class="def-name">arduinoioaddons.LCDAddon.LCD</strong><a class="copiable-link" href="#index-arduinoioaddons_002eLCDAddon_002eLCD"></a></span></dt>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-LCD_0028arObj_002c"><span class="category-def">: </span><span><code class="def-type"><var class="var">lcd</var> =</code> <strong class="def-name">LCD(arObj,</strong> <code class="def-code-arguments">rs, enable, d0, d1, d2, d3)</code><a class="copiable-link" href="#index-LCD_0028arObj_002c"></a></span></dt>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-freeLCD_0028_0029"><span class="category-def">: </span><span><strong class="def-name">freeLCD()</strong><a class="copiable-link" href="#index-freeLCD_0028_0029"></a></span></dt>
<dd><p>Free the LCD
</p>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-clearLCD_0028_0029"><span class="category-def">: </span><span><strong class="def-name">clearLCD()</strong><a class="copiable-link" href="#index-clearLCD_0028_0029"></a></span></dt>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-printLCD_0028text_0029"><span class="category-def">: </span><span><strong class="def-name">printLCD(<var class="var">text</var>)</strong><a class="copiable-link" href="#index-printLCD_0028text_0029"></a></span></dt>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-gotoLCD_0028col_002c"><span class="category-def">: </span><span><strong class="def-name">gotoLCD(<var class="var">col</var>,</strong> <code class="def-code-arguments"><var class="var">row</var>)</code><a class="copiable-link" href="#index-gotoLCD_0028col_002c"></a></span></dt>
