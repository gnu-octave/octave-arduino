...
<dt class="deftypefn def-line" id="index-arduinoioaddons_002eSimpleStepper"><span class="category-def">: </span><span><strong class="def-name">arduinoioaddons.SimpleStepper</strong><a class="copiable-link" href="#index-arduinoioaddons_002eSimpleStepper"></a></span></dt>
...
<dl class="first-deftypefn def-block">
<dt class="deftypefn def-line" id="index-rotate_0028sObj_002c"><span class="category-def">: </span><span><strong class="def-name">rotate(<var class="var">sObj</var>,</strong> <code class="def-code-arguments"><var class="var">dir</var>)</code><a class="copiable-link" href="#index-rotate_0028sObj_002c"></a></span></dt>
