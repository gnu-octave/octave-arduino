...
<dt class="deftypefn def-line" id="index-decrementResourceCount"><span class="category-def">: </span><span><code class="def-type"><var class="var">count</var> =</code> <strong class="def-name">decrementResourceCount</strong> <code class="def-code-arguments">(<var class="var">ar</var>, <var class="var">resource</var>)</code><a class="copiable-link" href="#index-decrementResourceCount"></a></span></dt>
