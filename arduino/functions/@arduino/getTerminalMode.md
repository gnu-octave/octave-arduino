...
<dt class="deftypefn" id="index-getTerminalMode"><span class="category-def">: </span><span><code class="def-type"><var class="var">mode</var> =</code> <strong class="def-name">getTerminalMode</strong> <code class="def-code-arguments">(<var class="var">ar</var>, <var class="var">terminal</var>)</code><a class="copiable-link" href='#index-getTerminalMode'></a></span></dt>
