...
<dt class="deftypefn def-line" id="index-isTerminalAnalog"><span class="category-def">: </span><span><code class="def-type"><var class="var">ret</var> =</code> <strong class="def-name">isTerminalAnalog</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">terminal</var>)</code><a class="copiable-link" href="#index-isTerminalAnalog"></a></span></dt>
