...
<dt class="deftypefn def-line" id="index-readDigitalPin"><span class="category-def">: </span><span><code class="def-type"><var class="var">value</var> =</code> <strong class="def-name">readDigitalPin</strong> <code class="def-code-arguments">(<var class="var">obj</var>, <var class="var">pin</var>)</code><a class="copiable-link" href="#index-readDigitalPin"></a></span></dt>
