...
<dt class="deftypefn def-line" id="index-writePWMVoltage"><span class="category-def">: </span><span><strong class="def-name">writePWMVoltage</strong> <code class="def-code-arguments">(<var class="var">ar</var>, <var class="var">pin</var>, <var class="var">voltage</var>)</code><a class="copiable-link" href="#index-writePWMVoltage"></a></span></dt>
