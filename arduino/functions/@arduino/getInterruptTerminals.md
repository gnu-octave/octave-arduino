...
<dt class="deftypefn def-line" id="index-getInterruptTerminals"><span class="category-def">: </span><span><code class="def-type"><var class="var">pinlist</var> =</code> <strong class="def-name">getInterruptTerminals</strong> <code class="def-code-arguments">(<var class="var">ar</var>)</code><a class="copiable-link" href="#index-getInterruptTerminals"></a></span></dt>
