...
<dt class="deftypefn def-line" id="index-getPinsFromTerminals"><span class="category-def">: </span><span><code class="def-type"><var class="var">pinnames</var> =</code> <strong class="def-name">getPinsFromTerminals</strong> <code class="def-code-arguments">(<var class="var">ar</var>, <var class="var">terminals</var>)</code><a class="copiable-link" href="#index-getPinsFromTerminals"></a></span></dt>
