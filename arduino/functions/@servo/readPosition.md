...
<dt class="deftypefn def-line" id="index-readPosition"><span class="category-def">: </span><span><code class="def-type"><var class="var">position</var> =</code> <strong class="def-name">readPosition</strong> <code class="def-code-arguments">(<var class="var">servo</var>)</code><a class="copiable-link" href="#index-readPosition"></a></span></dt>
