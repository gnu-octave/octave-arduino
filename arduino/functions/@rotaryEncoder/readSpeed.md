...
<dt class="deftypefn" id="index-readSpeed"><span class="category-def">: </span><span><code class="def-type"><var class="var">speed</var> =</code> <strong class="def-name">readSpeed</strong> <code class="def-code-arguments">(<var class="var">obj</var>)</code><a class="copiable-link" href='#index-readSpeed'></a></span></dt>
