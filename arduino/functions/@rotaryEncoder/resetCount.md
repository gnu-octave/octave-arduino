...
<dt class="deftypefn def-line" id="index-_0028obj_0029"><span class="category-def">: </span><span><code class="def-type">reset</code> <strong class="def-name">(<var class="var">obj</var>)</strong><a class="copiable-link" href="#index-_0028obj_0029"></a></span></dt>
<dt class="deftypefnx def-cmd-deftypefn def-line" id="index-_0028obj_002c"><span class="category-def">: </span><span><code class="def-type">reset</code> <strong class="def-name">(<var class="var">obj</var>,</strong> <code class="def-code-arguments"><var class="var">cnt</var>)</code><a class="copiable-link" href="#index-_0028obj_002c"></a></span></dt>
