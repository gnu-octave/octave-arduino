...
function retval = config_due (initdata)
  ...
  retval.pins{end+1} = arduinoio.config.pin_info('D4', 4, { 'digital', 'pwm' }); # D87
  ...
  retval.pins{end+1} = arduinoio.config.pin_info('D10', 10, { 'digital', 'pwm' }); # D77
  ...
  retval.pins{end+1} = arduinoio.config.pin_info('D13', 13, { 'digital', 'pwm' 'led_13', 'led' });
  ...
  retval.pins{end+1} = arduinoio.config.pin_info('D18', 18, { 'digital', 'uart1_tx'});
  retval.pins{end+1} = arduinoio.config.pin_info('D19', 19, { 'digital', 'uart1_tx' });
  ...
  retval.pins{end+1} = arduinoio.config.pin_info('D71', 71, { 'digital', 'ic21_scl' });
